...
[Files]
; Bundle the entire Nuitka standalone distribution directory
Source: "build\grammar-ai.dist\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
